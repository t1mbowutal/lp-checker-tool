(() => {
  ...
  async function analyze() {
    ...
    try {
      ...
      document.querySelector('#summary').innerHTML = `<div class="exec">
      ...
      const pos = document.querySelector('#positives'); pos.innerHTML='';
      const imp = document.querySelector('#improvements'); imp.innerHTML='';
