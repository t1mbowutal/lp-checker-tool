        ...
        {data && (<>
          ...
          <div className="score-grid">
            <div className="score-card">
              <h4>Overall <span title="Gewichtete Kombination: 40% BoFu, 30% Convincing, 30% Technical." style={{marginLeft:6,cursor:"help",opacity:.75,fontSize:12}}>i</span></h4>
              <div className="bar">
            ...
            <div className="score-card">
              <h4>Purchase / BoFu <span title="Konversionspfad: Formular/CTA, direkte Kontaktwege, Preissignale." style={{marginLeft:6,cursor:"help",opacity:.75,fontSize:12}}>i</span></h4>
              <div className="bar">
            ...
            <div className="score-card">
              <h4>Convincing <span title="Trust & Belege: Testimonials, Cases, Zertifikate; sichtbare Ergebnisse/Zahlen." style={{marginLeft:6,cursor:"help",opacity:.75,fontSize:12}}>i</span></h4>
              <div className="bar">
            ...
            <div className="score-card">
              <h4>Technical <span title="Hygiene: Title, Meta Description, H1, Canonical, HTTPS." style={{marginLeft:6,cursor:"help",opacity:.75,fontSize:12}}>i</span></h4>
              <div className="bar">
