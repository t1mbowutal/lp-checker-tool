        ...
        {data && (<>
          ...
          <div className="score-grid">
            <div className="score-card">
              <h4>Overall<Info title="Gewichtete Kombination: 40% BoFu, 30% Convincing, 30% Technical." />/h4>
              <div className="bar">
            ...
            <div className="score-card">
              <h4>Purchase / BoFu<Info title="Konversionspfad: Formular/CTA, direkte Kontaktwege, Preissignale." />/h4>
              <div className="bar">
            ...
            <div className="score-card">
              <h4>Convincing<Info title="Trust & Belege: Testimonials, Cases, Zertifikate; sichtbare Ergebnisse/Zahlen." />/h4>
              <div className="bar">
            ...
            <div className="score-card">
              <h4>Technical<Info title="Hygiene: Title, Meta Description, H1, Canonical, HTTPS." />/h4>
              <div className="bar">
