...
function barStyle(n:number){ const s=Math.round(n||0); return { width: `${s}%`, backgroundColor: s>=67? "#166534": s>=34? "#b45309":"#991b1b" }; }

function scoreClass(n:number){ const s=Math.round(n||0); return s>=67? "bar-hi": s>=34? "bar-mid":"bar-lo"; }
